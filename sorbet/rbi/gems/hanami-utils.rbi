...
module Hanami::Utils::Files
  def self._append_newline?(content); end
...
class Hanami::Logger::Filter
  ...
  def _copy_params(params); end
  def _deep_dup(hash); end
  def _deep_merge(original_hash, filtered_hash); end
  def _filter(params); end
  def _filter_hash(hash); end
