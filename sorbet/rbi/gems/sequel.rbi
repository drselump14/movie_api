...
class Sequel::Postgres::Dataset < Sequel::Dataset
  ...
  def fetch_rows_set_cols(arg0); end
  def literal_blob_append(sql, v); end
  def literal_string_append(sql, v); end
  ...
  def yield_hash_rows(arg0, arg1); end
...
class Sequel::Postgres::JSONArrayBase < Anonymous_Delegator_121
  def sql_literal_append(ds, sql); end
  include Sequel::SQL::AliasMethods
  include Sequel::SQL::CastMethods
end
...
class Sequel::Postgres::JSONHashBase < Anonymous_Delegator_122
  def sql_literal_append(ds, sql); end
  def to_hash; end
  include Sequel::SQL::AliasMethods
  include Sequel::SQL::CastMethods
...
class Sequel::Postgres::HStore < Anonymous_Delegator_123
  def [](k); end
  def []=(k, v); end
  def _dump(*arg0); end
  def assoc(k); end
...
module Sequel::Database::FreezeDatasets::DatasetMethods
  def dup; end
end
